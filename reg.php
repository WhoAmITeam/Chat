...
<head>
    ...
    <title>CRINGE.ME | Регистрация </title>
        ...
        <div class="container">
            ...
            <form action="php/reg.php" method="post">
                ...
                <input type="password" name="password2"
                       ...
                       autocomplete="off"
                       required><br>
                <input type="submit" name="btn" value="Зарегестрироваться">
            </form>
            <hr>
            <button class="btn_link" onclick="window.location.href = 'index.php';">Войти 🡦</button>
